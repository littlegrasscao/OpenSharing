...
import io.opensharing.OpenSharingServer;
...
public final class OpenSharing {
  ...
  public static ConfigurableApplicationContext runStandalone(String... args) {
    return SpringApplication.run(OpenSharingServer.class, args);
  }
  ...
  public static final class EmbeddedBuilder {
    ...
    public ConfigurableApplicationContext run(String... args) {
      ...
      return new SpringApplicationBuilder(OpenSharingServer.class)
          .properties(merged)
          .initializers(new EmbeddedInitializer(catalog, identityResolver))
          .run("--opensharing.hosting.mode=embedded");
    }
  }
